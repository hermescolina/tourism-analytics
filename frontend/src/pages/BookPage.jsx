...
export default function BookPage() {
    ...
    useEffect(() => {
        fetch('https://api.tourwise.shop/api/tour-titles')
            .then(res => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://api.tourwise.shop/api/book-tour', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className={styles.bookingPage}>
            ...
            <form onSubmit={handleSubmit} className={styles.bookingForm}>
                ...
                {formData.tour_slug && (
                    <a
                        href={`https://app.tourwise.shop/tourism-analytics/tour/${formData.tour_slug}`}
                        target="_blank"
